...
public class GameSystem {
    ...
    static void finalAccount(){
        ...
        for (Player p:alives){
            if (p.hp+p.mp==bigwinner){
                System.out.println("bigwinner: player"+p.code);
            }
        }
        for (Player p:alives){
            if (p.hp+p.mp!=bigwinner){
                System.out.println("winner: player"+p.code);
            }
        }
        for (Player p:deads){
        ...
        for(Player p:deads){
            if (p.hp+p.mp==bigloser){
                System.out.println("bigloser: player"+p.code);
            }
        }
        for(Player p:deads){
            if (p.hp+p.mp!=bigloser){
                System.out.println("loser: player"+p.code);
            }
        }
    }
}
